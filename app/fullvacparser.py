...
def parser(text, csvname, area='1', pages=None, mode = 0):
    ...
    #Режим возврата df с вакансиями по запросу
    if mode == 1:
        return df
    #Режим возврата df с скилами по запросу
    if mode == 2:
        return dfstat

    # Параметры: Поиск по имени, название файла, код города, кольво страниц
parser('python', 'test6', '2', 3, 1)